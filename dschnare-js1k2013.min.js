...
a.fillStyle="#969696";a.fillRect(0,0,600,600);j=1;f=e=0;p=r=300;v=l.call(d,"button");v.innerHTML="Clear";v.onclick=function(){c.width=600;a.fillStyle="#969696";a.fillRect(0,0,600,600);a.fillStyle=w};h.call(b,v);v=v.cloneNode();v.innerHTML="Save";v.onclick=function(){window.location=c.toDataURL()};h.call(b,v);n.call(b,"keydown",function(u,m){m=u.keyCode;e=65==m||83==m?m:e;f=75==m||76==m?m:f});n.call(b,"keyup",function(u){k=u.keyCode;e=65==k||83==k?-1:e;f=75==k||76==k?-1:f});a.fillStyle=w="#1E1E1E";
x();
